    ...
    */
    ...
    'custom' => [
        ...
        'jenis_kelamin' => [
            ...
            'in' => 'Jenis Kelamin harus di isi L atau P',
        ],
        'tanggal_lahir' => [
        ...
        'nomor_telepon' => [
            ...
            'numeric'=> 'Nomer Telepon Harus di isi angka',
            'digits_between' => 'Nomer Telepon harus antara :min atau :max digit'
        ],
        'id_kelas' => [
            'required' => 'Kelas Harus Di pilih',
        ],
        'foto' => [
            'image' => 'Yang di upload hanya berupa gambar / Foto',
            'max' => 'Foto tidak boleh lebih dari 500 KB',
            'mimes' => 'Foto hanya boleh di isi dengan dile *.jpeg, *.jpg, *.bmp, *.png',
            'dimensions' => 'Foto Harus berukuran 150x180 pixel',
        ],
        'nama_kelas' => [
            'required' => 'Kolom Nama Kelas harus di isi',
            'string' => 'Kolom Nama Kelas harus berupa string',
            'max' => 'Kolom Nama Kelas tidak boleh lebih dari :max karakter',
        ],
        'nama_hobi' => [
            'required' => 'Kolom Nama Hobi harus di isi',
            'string' => 'Kolom Nama Hobi harus berupa string',
            'max' => 'Kolom Nama Hobi tidak boleh lebih dari :max karakter',
        ],
        'email' => [
        ...
        'password' => [
            ...
            'min' => 'Passowrd minimal 6 karakter',
        ],
